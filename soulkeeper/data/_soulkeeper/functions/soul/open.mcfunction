...
data modify storage racoonia:soulkeeper xp set from entity @s data.soulkeeper.xp
...
data modify storage racoonia:soulkeeper items set from entity @s data.soulkeeper.items
