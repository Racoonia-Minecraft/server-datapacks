...
# Ressurection
execute as @e[x=-500,y=-128,z=-500,dx=1000,dy=64,dz=1000,tag=lobbyanimal] run function _lobbymanager:resurrect/animal
execute as @a[x=-500,y=-128,z=-500,dx=1000,dy=104,dz=1000] at @s run function _lobbymanager:resurrect/player
