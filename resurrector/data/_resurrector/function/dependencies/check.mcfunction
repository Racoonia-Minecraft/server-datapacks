...
execute unless score #provided racoonia.dependencies matches 2.. run tellraw @a [{"text":"Datapack ","color":"white"},{"text":"resurrector","color":"green"},{"text":" needs ","color":"white"},{"text":"racooniacore","color":"green"},{"text":" version ","color":"white"},{"text":"2","color":"green"},{"text":" or greater, but version ","color":"white"},{"score":{"name":"#provided","objective":"racoonia.dependencies"},"color":"green"},{"text":" was provided.","color":"white"}]

scoreboard objectives remove racoonia.dependencies

function _resurrector:load
